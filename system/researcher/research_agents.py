...
1. Вопросы должны быть четкими, конкретными, содержащими ключевые слова из работы, для того чтобы по ним можно было искать в интернете. 
2. Вопросы не должны быть абстрактными.
